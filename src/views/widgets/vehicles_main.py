"""
Module: Widget principal des véhicules
...
from src.views.widgets.vehicles_dashboard import VehiclesDashboard
from src.views.widgets.vehicles_management import VehiclesManagement


class VehiclesMainWidget(QWidget):
    """Widget principal des véhicules avec onglets"""
